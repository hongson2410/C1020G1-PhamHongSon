...
import com.codegym.services.impl.login.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/employee/list","/employee/create","/employee/edit/{id}",
                "/employee/edit","/employee/delete","/employee/search").access("hasRole('ROLE_MANAGER')");
