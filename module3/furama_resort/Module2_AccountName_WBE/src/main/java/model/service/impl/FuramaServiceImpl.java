...
public class FuramaServiceImpl implements FuramaService {
    ...
    public String saveCustomer(String customer_id, String customer_type_id, String customer_name, String customer_birthday,
        ...
        if (!customer_type_id.matches("\\d*") || !customer_gender.matches("\\d*")){
    ...
    @Override
    public String saveService(String service_name, String service_area, String service_cost,
        ...
        Service service;
        if (service_name.equals("Villa")){
            if (service_name.equals("") || service_area.equals("") || service_cost.equals("") || service_max_people.equals("")
            ...
            service = new Service(service_name, Integer.parseInt(service_area), Double.parseDouble(service_cost),
